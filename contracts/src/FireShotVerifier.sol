...
contract PlonkFireShotVerifier {
    
    uint32 constant n =   16384;
    uint16 constant nPublic =  3;
    uint16 constant nLagrange = 3;
    
    uint256 constant Qmx = 6740677488765929708020409814764241043595650586977378775774814626782178809991;
    uint256 constant Qmy = 4150499740850640846184479770780129260444686125097900622252036764586809458855;
    uint256 constant Qlx = 15084417980386447281763176710053169090420670583899988249986037869514158794461;
    uint256 constant Qly = 16267620936541491512300899300591324336906043105048979935823388515854783177324;
    uint256 constant Qrx = 19201202442906636732402823698975759065791898168935778069101826211739482715721;
    uint256 constant Qry = 13673225022774151048938868135235829326806136508622493643238089741517134427721;
    uint256 constant Qox = 18339277919980579130665426782987181610829572186977705626790186706013920876986;
    uint256 constant Qoy = 3768312576020647879439507089935946827513437538043113835520428775214095170019;
    uint256 constant Qcx = 251391237574513144100818866660523183207829916994863363419034928572882322346;
    uint256 constant Qcy = 3071100751428152348250422376910559585158819013573007873984018370104560842055;
    uint256 constant S1x = 18923952739437755435482728059031634048214911466311957752008092913450802124223;
    uint256 constant S1y = 13088487828700837179855516591355666118505429193147772235468570773731512454532;
    uint256 constant S2x = 21705401620739095566197144432037156897416393129439286611965496878959790760424;
    uint256 constant S2y = 6807375669704557555896836028176089188118737718929750555054165783040673888786;
    uint256 constant S3x = 10812955634686991007382208903502839520130348606345276003909567756399496950306;
    uint256 constant S3y = 15746392259362692136995623157375291347301907826573219048041412001581697306252;
