...
contract PlonkBoardSetupVerifier {
    
    uint32 constant n =   16384;
    uint16 constant nPublic =  1;
    uint16 constant nLagrange = 1;
    
    uint256 constant Qmx = 9524371802982659154563401879472273646449138896323933023040834632484254291487;
    uint256 constant Qmy = 13281018697975211820421425767977754057820541479707146543787205012908592388650;
    uint256 constant Qlx = 3577887321785311004671922010635908511327415977905657521596305200736979516388;
    uint256 constant Qly = 497239664211909844393823061990081692800259569017698026253922504306967074203;
    uint256 constant Qrx = 1401991637091812916773398875321843249059807571364180146560802812019747631839;
    uint256 constant Qry = 8070209351065052143718296709532349929843845673429636616912743779586843392363;
    uint256 constant Qox = 5659448234314817191216097828538514468993995526199889769188550115701725077554;
    uint256 constant Qoy = 19628749528536736488331277319650218580959446978738012788911922442798803700908;
    uint256 constant Qcx = 55249742898523354404148859252752175932095418067574391384715482429581411010;
    uint256 constant Qcy = 8433993461315975008146755774485551733932120477281375372745550780008438873073;
    uint256 constant S1x = 13944544464741692434302908065616923847119017918739397410676236998730275532723;
    uint256 constant S1y = 13778112964782456690806879045267845380617969245229411138570814978626324563217;
    uint256 constant S2x = 20337981706529458840220891252522728958268709239000456091813795841236952424410;
    uint256 constant S2y = 21825715315578131992993702352934330793537538220135213426604947782939764076737;
    uint256 constant S3x = 6533468516616981682179625461620679089961247754835834541075428995387980723266;
    uint256 constant S3y = 1681433647621840945606378621399733668571844453220522661485513597371063432581;
